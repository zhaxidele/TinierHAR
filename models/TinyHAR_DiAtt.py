...
class SelfDifferentialAttention_interaction(nn.Module):
    """
    Self-Differential-Attention mechanism for channel interaction.
    """

    # num_hidden = n_channels
    # num_heads = 8
    # seq_len = sensor_channel
    # d_k = 1             
    ...
    def forward(self, query, key, values, dropout=0.1):
        # Input dimensions: (batch_size, sensor_channel, feature_dim)
...
crosschannel_interaction = {
    ...
    "diff_attn": SelfDifferentialAttention_interaction,
...
class FilterWeighted_Aggregation(nn.Module):
    """
    Filter weighted aggregation mechanism.
    """
    def __init__(self, sensor_channel, n_channels):
...
class NaiveWeighted_Aggregation(nn.Module):
    """
    Naive weighted aggregation mechanism.
    """
...
class Weighted_Aggregation(nn.Module):
    """
    Weighted aggregation mechanism with Tanh activation.
    """
    def __init__(self, sensor_channel, hidden_dim):
...
class seperate_FC_channel_first(nn.Module):
    """
    Separate fully connected layer (channel first).
    """
    def __init__(self, sensor_channel, filter_num):
    ...
    def forward(self, x):
        # Input: (batch_size, length, sensor_channel, filter_num)
        x = x.permute(0, 1, 3, 2)
...
class seperate_FC_filter_first(nn.Module):
    """
    Separate fully connected layer (filter first).
    """
    def __init__(self, sensor_channel, filter_num):
...
class seperate_FC_filter_first_v2(nn.Module):
    """
    Improved version of separate fully connected layer (filter first).
    """
    def __init__(self, sensor_channel, filter_num):
...
class FC_Weighted_Aggregation(nn.Module):
    """
    Fully connected weighted aggregation mechanism.
    """
    def __init__(self, sensor_channel, hidden_dim):
...
class temporal_conv_1d(nn.Module):
    """
    1D Convolution for temporal interaction.
    """
